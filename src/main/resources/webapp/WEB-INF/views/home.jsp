...
program. If not, see <https://www.gnu.org/licenses/>. --%> <%@ include
file="00-header.jsp" %>
<div class="content">
		...
		<a class="tileRow1" href="${ctxPath}/manager/home/ocppJsonStatus">
			...
			<span class="baseRow">
				...
				<span class="baseRow">
					...
					<span class="baseCell formatNumber"
						>${stats.numOcpp16JChargeBoxes}</span
					>
				</span>
			</span>
		</a>
		<a class="tileRow1" href="${ctxPath}/manager/chargepoints">
			...
			<span class="baseTable">
				<span class="baseRow">
					...
					<span class="baseCell formatNumber"
						>${stats.heartbeatToday}</span
					>
				</span>
				<span class="baseRow">
					<span class="baseCell">Yesterday :</span>
					<span class="baseCell formatNumber"
						>${stats.heartbeatYesterday}</span
					>
				</span>
				<span class="baseRow">
					<span class="baseCell">Earlier :</span>
					<span class="baseCell formatNumber"
						>${stats.heartbeatEarlier}</span
					>
				</span>
			</span>
		</a>
